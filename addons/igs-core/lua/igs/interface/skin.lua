...
IGS.S.COLORS = {
	FRAME_HEADER        = Color(121,89,54), -- Фон верхушки фреймов в т.ч. пополнения счета и т.д. https://img.qweqwe.ovh/1491950958825.png
	ACTIVITY_BG         = Color(100,75,47), -- Фон в каждой вкладке (основной) https://img.qweqwe.ovh/1509370647204.png
	...
	SOFT_LINE           = Color(156,129,103), -- Линия между секциями, типа "Информация" и "Описание" в инфе об итеме
	HARD_LINE           = Color(132,105,75), -- Обводки панелей

	HIGHLIGHTING        = Color(226,156,75),   -- Обводка кнопок, цвет текста не активной кнопки
	...
	LOG_ERROR           = Color(255,112,143),   -- В логах пополнения цвет ошибок
	LOG_NORMAL          = Color(193,250,207),       -- В логах пополнения обычные записи

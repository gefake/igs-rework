...
IGS.C.CURRENCY_NAME = "Жетоны" -- Фановое название. Можете изменить
IGS.C.CURRENCY_SIGN = "жетоны Метро"
=======
IGS.C.CURRENCY_NAME = "Алкобаксы" -- Фановое название. Можете изменить
IGS.C.CURRENCY_SIGN = "Alc"
>>>>>>> 530a9117972062434a25c8442a1f6fd9fcad2815
